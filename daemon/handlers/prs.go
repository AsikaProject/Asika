...
func GetPRDiff(c *gin.Context)         { pr.GetPRDiff(c) }
...
func CommentPRLine(c *gin.Context)     { pr.CommentPRLine(c) }
...
func BatchMergePR(c *gin.Context)      { pr.BatchMergeHandler(c) }
func BatchCherryPickPR(c *gin.Context) { pr.BatchCherryPickHandler(c) }
